...
int * take_step(int state[22], int move){
    ...
    int * new_state = malloc(22*sizeof(int));
    ...
    for (int i = 0; new_state[i] != 16 && i<15; i++){
        Forme * f = malloc(sizeof(Forme));
        f = getValRev(state[i+7]);
    ...
    for(int i = mainlist->length+7; i<22; i++){
        new_state[i] = 16;
    }
...
int main(){
    int array[] = {0, 0, 12, 13, 5, 6, 4, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16};
